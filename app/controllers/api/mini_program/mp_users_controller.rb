class Api::MiniProgram::MpUsersController < ApplicationController
  ...
  def new
    ...
    bind_params = {
      ...
      pre_auth_code: ComponentAppSetting.fetch_pre_auth_code(current_site.wx_mp_user),
  ...
  def bind_callback
    ...
    mp_user = MpUserSetting.fetch_info_by_auth_code(current_site, params[:auth_code])
    if mp_user
