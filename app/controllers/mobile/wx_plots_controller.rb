class Mobile::WxPlotsController < Mobile::BaseController
  ...
  private
    ...
    def set_site_website
      ...
      @list_template_id = @website_setting.list_template_id.to_i == 0 ? 1 : @website_setting.list_template_id.to_i
      @detail_template_id = @website_setting.detail_template_id.to_i == 0 ? 1 : @website_setting.detail_template_id.to_i
    end
