  ...
  private
    def fetch_payment_settings
      ...
      @payment_settings = [
        ...
        # @payment_settings.cashpay.first || @payment_settings.new(payment_type_id: 10000)
        # @payment_settings.tenpay.first || @payment_settings.new(payment_type_id: 10004),
        # @payment_settings.proxy_wxpay.first || @payment_settings.new(payment_type_id: 20001),
