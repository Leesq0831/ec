...
class Sms::MessagesController < ApplicationController
  ...
  # 发送付费短信http接口,调用方法如下：
  # RestClient.post("http://dev.winwemedia.local:3000/sms/messages/send_message", {template_code: '', phone: '13262902619', sms_params: { code: 123 }, operation_id: '2', site_id: 10001, userable_id: 10001, userable_type: 'User'})
  # 发送免费短信http接口调用方法如下：
  # RestClient.post("http://dev.winwemedia.local:3000/sms/messages/send_message", {template_code: '', phone: '13262902619', sms_params: { code: 123 }, operation_id: '2', site_id: 10001, userable_id: 10001, userable_type: 'User', is_free: 1})
  def send_message
    errors = []
