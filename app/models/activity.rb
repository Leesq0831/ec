class Activity < ActiveRecord::Base
  ...
  def respond_mobile_url(activity_notice = nil, options = {})
    ...
    url = case
      ...
      # when oa?                 then "#{Settings.oa_host}/woa-all/wx/#{site_id}/index?openid=#{options[:openid]}"
      when hotel?              then "#{Settings.hotel_host}/wehotel-all/weixin/mobile/website.jsp?site_id=#{site_id}&openid=#{options[:openid]}"
