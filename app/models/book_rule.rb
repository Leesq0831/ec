class BookRule < ActiveRecord::Base
  store :metadata, accessors: [:delivery_time, :shop_notice, :is_limit_range, :kilometer, :over_money, :need_wx_message, :deliver_amount]
  ...
  :is_limit_day, :is_limit_time, :is_open_hall, :is_open_loge, :hall_limit_money, :loge_limit_money, :is_pay_balance, :delivery_time, :shop_notice,
                  :is_limit_range, :kilometer, :over_money, :need_wx_message, :deliver_amount

  validates :shop_branch_id, presence: true

  validates :deliver_amount, numericality: { greater_than_or_equal_to: 0 }, on: :update
