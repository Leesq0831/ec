class Booking < ActiveRecord::Base
  store :metadata, accessors: [:notify_merchant_mobiles, :is_open_booking, :descr_placeholder, :is_require_descr, :need_wx_message, :merchant_openids, :deliver_amount]
...
#  default_scope -> { order('created_at desc') }
  ...
  def merchant_openid_list
    merchant_openids.split(/[\r\n]+/)
  end
end
