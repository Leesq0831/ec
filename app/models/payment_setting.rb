class PaymentSetting < ActiveRecord::Base
  ...
  store :metadata, accessors: [:sub_mch_id, :sub_appid]
  ...
  WEIXIN_NOTICE_URL =  "#{Settings.pay_host}/api/mini_program/wxpay/notify"
  WEIXIN_PAY_URL =  "#{Settings.pay_host}/api/mini_program/wxpay/pay"
  ...
  def update_type
    if self.wxpay? || self.proxy_wxpay?
