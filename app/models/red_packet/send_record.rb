  ...
  def pay
    ...
    if return_code == 'SUCCESS'
      ...
      if result_code == 'SUCCESS'
        ...
        write_wxredpacket_log "pay fail ========= site_id = #{site.id}, out_trade_no = #{out_trade_no}, openid = #{openid}, total_amount = #{total_amount.to_f}, return_msg = #{result[:return_msg]}, err_code_des = #{result[:err_code_des]}"
  ...
  def query
    ...
    if return_code == 'SUCCESS'
      ...
      if result_code == 'SUCCESS'
        ...
        write_wxredpacket_log "query fail ========site_id = #{site.id}, out_trade_no = #{out_trade_no}, openid = #{openid}, total_amount = #{total_amount.to_f}, return_msg = #{result[:return_msg]}, err_code_des = #{result[:err_code_des]}"
      end
    elsif return_code == 'FAIL'
      write_wxredpacket_log "query fail ========site_id = #{site.id}, out_trade_no = #{out_trade_no}, openid = #{openid}, total_amount = #{total_amount.to_f}, return_msg = #{result[:return_msg]}, err_code_des = #{result[:err_code_des]}"
    else
