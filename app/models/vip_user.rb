class VipUser < ActiveRecord::Base
  ...
  after_create :send_sms_notification, :send_register_points, :get_register_points
  ...
  private
    ...
    def get_register_points
      ...
      if point_rule.enabled? && point_rule.register_points.to_i > 0
        transaction do
          update_attributes(
            total_points: point_rule.register_points.to_i,
            usable_points: point_rule.register_points.to_i
          )
          point_transactions.create(
            ...
            points: point_rule.register_points.to_i,
            description: '注册送积分'
          )
        end
      end
