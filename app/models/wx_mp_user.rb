...
class WxMpUser < ActiveRecord::Base
  ...
  store :metatada, accessors: [
    :new_order_wx_message_template_id, :cancel_order_wx_message_template_id,
    :order_paid_wx_message_template_id, :order_packing_wx_message_template_id,
    :order_delivered_wx_message_template_id, :order_delivery_wx_message_template_id,
    :mobile, :template_id, :user_version, :new_user_version, :new_template_id, :auditstatus,
    :fail_reason, :mp_ticket, :requestdomain, :wsrequestdomain, :uploaddomain, :downloaddomain,
    :wechatid, :mp_code
  ]
  ...
  belongs_to :account#, inverse_of: :wx_mp_user
  ...
  def generate_url
    ...
    update_attributes(url: "#{Settings.www_host}/service/#{user_code}")
  end
