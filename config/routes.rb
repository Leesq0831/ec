...
Wp::Application.routes.draw do
  ...
  get '/:verify_file', to: 'platforms#verify', constraints: { verify_file: /MP_verify_.+\.txt/ }
  ...
  resources :provinces, :cities, :districts
  ...
  resources :employees, :employee_roles
